        ...
        for id in tcx.hir_free_items() {
            ...
            match item_kind {
                ...
                DefKind::Fn | DefKind::AssocFn => {
                    ...
                    let decl = tcx.hir_fn_decl_by_hir_id(item_did.into()).unwrap();
                ...
                DefKind::OpaqueTy => {
                    ...
                    for (predicate, span) in evil_intimidating {
                        debug!("trait={predicate:?}, span={span:?}");

                        let Some(lang_item) = tcx.as_lang_item(predicate.trait_ref.def_id) else {
                            continue;
                        };
                        ...
                        match lang_item {
                            Fn | FnMut | FnOnce => {
                                let args_ty = predicate.trait_ref.args.type_at(1);
                                debug!("Fn/FnMut/FnOnce! args={args_ty:?}");
